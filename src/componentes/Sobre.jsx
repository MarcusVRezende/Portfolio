          ...
          <div className="conteudo-texto-sobre">
            ...
            <div className="texto-sobre">
              <p>
                ...
                desenvolvimento Full Stack. Atualmente estou me aprofundando em
                tecnologias front-end para criar interfaces mais intuitivas e
                performáticas.
              </p>
              <p>
                Minha jornada combina a base teórica da faculdade com projetos
                práticos, buscando sempre aplicar o que aprendo em soluções
                reais. Acredito que um bom desenvolvedor precisa entender toda a
                stack.
              </p>
              <p>
                Quando não estou codando, você pode me encontrar estudando novas
                tecnologias, contribuindo em projetos open source ou explorando
